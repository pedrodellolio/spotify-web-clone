    ...
    <footer className="fixed bottom-0 bg-[#000] p-4 w-full h-[88px]">
      <div className="flex flex-col justify-center items-center gap-2">
        ...
        <div className="flex flex-row w-full items-center gap-2">
          <p className="text-[0.687rem] text-[#a7a7a7]">1:20</p>
          <div className="w-full h-1 rounded-full bg-[#ffffff4d]">
            <div className="w-[30%] h-1 rounded-full bg-[#ffff]"></div>
          </div>
          <p className="text-[0.687rem] text-[#a7a7a7]">3:30</p>
        </div>
      </div>
    </footer>
  );
